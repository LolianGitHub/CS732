 ...
 */
export function forEachBecauseIForgotThisIsAlreadyPartOfJSArraysByDefault(array, callback) {
 ...
 * 
 * We might want to test this by replacing fetch() with something that does what we want it to.
 */
export async function getArticle(articleId) {
    const response = await fetch(`https://trex-sandwich.com/ajax/articles?id=${articleId}`);
